...
#' @param type Type of plot: "venn", "vennpie", "upset", or "bar"
...
#' @param showNumbers Logical: show counts/percentages? Default: TRUE (venn)
...
#' @param show_unique_only Logical: unique only? Default: FALSE (venn)
#' @param scaled Logical: scale by size? Default: FALSE (venn)
#' @param subset Character vector of subset names (vennpie)
#' @param top Max subsets to display, default: 31 (vennpie)
#' @param min Min sets an element must be in, default: 0 (vennpie/upset)
#' @param color Optional colors vector (vennpie/bar)
#' @param revcolor Color for non-highlighted subsets, default: "lightgrey" (vennpie)
#' @param any Highlight subsets shared by exactly this many sets (vennpie)
#' @param show.number Logical: show counts in labels? Default: TRUE (vennpie)
#' @param show.x Logical: show subset labels? Default: TRUE (vennpie)
#' @param sep Separator for subset names, default: "_" (vennpie)
#' @param log Logical: log scale? Default: FALSE (vennpie)
#' @param base Base for log transformation (vennpie)
#' @param percentage Logical: show percentages? Default: FALSE (vennpie)
#' @param nintersects Max intersections to show, default: 40 (upset)
#' @param min_size Min intersection size, default: 1 (upset)
...
#' @param show_numbers Logical: show counts on bars? Default: TRUE (upset)
#' @param sort_intersections_by Sort by "freq", "degree", or "custom" (upset)
#' @param sort_sets_by Sort sets by "size", "name", or "custom" (upset)
#' @param sort_sets_decreasing Sort sets decreasing? Default: TRUE (upset)
#' @param custom_sets_order Custom set order (upset)
#' @param sort_intersections_decreasing Sort intersections decreasing? Default: TRUE (upset)
...
#' @param empty_point_size Size of empty points, default: 1.5 (upset)
#' @param bar_width Width of bars, default: 0.7 (upset)
#' @param text_angle Text label angle, default: 0 (upset)
#' @param text_size Text size, default: 10 (upset)
#' @param set_label_size Set size label size, default: 3 (upset)
...
#' @param set_size_show_values Show set size values? Default: TRUE (upset)
#' @param intersection_size_show_values Show intersection values? Default: TRUE (upset)
#' @param show_empty_intersections Show empty intersections? Default: FALSE (upset)
#' @param show_set_labels Show set labels? Default: TRUE (upset)
#' @param plot_margin Plot margin in cm, default: 0.5 (upset)
#' @param height_ratio Matrix to total height ratio, default: 0.7 (upset)
#' @param width_ratio Set size to total width ratio, default: 0.3 (upset)
#' @param bar_offset Horizontal bar offset, default: -0.01 (upset)
#' @param set_text_size Set label size, default: 10 (upset)
#' @param intersection_title Intersection plot title (upset)
#' @param set_size_title Set size plot title (upset)
#' @param matrix_point_shape Point shape, default: 21 (upset)
#' @param number_color_threshold Color switch threshold, default: 0.75 (upset)
#' @param number_colors Named color vector for bar labels (upset)
#' @param theme_params List of theme parameters (upset)
#' @param return_data Return data with plot? Default: FALSE (upset)
#' @param order Logical: order bars by count? Default: FALSE (bar)
#' @param textsize Text label size, default: 5 (bar)
#' @param theme ggplot2 theme, default: theme_light() (bar)
